...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for data_dict in models.get("DBPublisher", []):
            p, created = DBPublisher.objects.get_or_create(
        ...
        for data_dict in models.get("DBBook", []):
            b, created = DBBook.objects.get_or_create(
        ...
        for data_dict in models.get("DBContributor", []):
            c, created = DBContributor.objects.get_or_create(
            ...
            if created:
                print(
                    'Created DBContributor "{} {}"'.format(
                        data_dict["contributor_first_name"], data_dict["contributor_last_name"]
                    )
                )
        ...
        for data_dict in models.get("DBBookContributor", []):
            ...
            bc, created = DBBookContributor.objects.get_or_create(
        ...
        for data_dict in models.get("DBReview", []):
            ...
            review, created = DBReview.objects.get_or_create(
